def classify_with_naive_bayes(classified_points, points_to_classify):
    ...
    for point_to_classify in points_to_classify:
        ...
        p_of_point_being_scam = prob_of_scam * p_scam_with_point_error_val * p_scam_with_point_link_val
        p_of_point_being_nonscam = prob_of_nonscam * p_nonscam_with_point_error_val * p_nonscam_with_point_link_val
...
classified_data = [{'scam': False, 'errors': False, 'links': False},
...
data_to_classify = [{'errors': False, 'links': False},
