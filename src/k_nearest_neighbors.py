...
class KNearestNeighborsClassifier:
    ...
    def classify(self, input_point):
        ...
        classification_count_dict = {classification: 0 for classification in classifications}
        classification_with_max_count = classifications[0]

        for classification in classifications:
            classification_count_dict[classification] += 1
            if classification_count_dict[classification] > classification_count_dict[classification_with_max_count]:
