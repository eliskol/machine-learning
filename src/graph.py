...
class Graph:
    ...
    def get_children(self, node):
        if node in self.children_by_id: return self.children_by_id[node]
        return None


    def get_parents(self, node):
        if node in self.parents_by_id: return self.parents_by_id[node]
        return None
    ...
    def breadth_first(self, node):
        ...
        while queue.contents != []:
            ...
            if node_children is None: continue
    ...
    def depth_first(self, node):
        ...
        while stack.contents != []:
            ...
            if top_element_children is None: continue
