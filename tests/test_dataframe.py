...
assert df6.order_by("age", ascending=True).to_json() == [
    {"firstname": "Kevin", "lastname": "Fray", "age": 5},
    {"firstname": "Sylvia", "lastname": "Mendez", "age": 9},
    {"firstname": "Anna", "lastname": "Smith", "age": 13},
    {"firstname": "Charles", "lastname": "Trapp", "age": 17},
]
