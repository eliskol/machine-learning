...
assert (matrix_1 + matrix_2) == "invalid matrix dimensions"
assert (matrix_3 + matrix_4).rows == [[5, 5], [5, 5]]

assert (matrix_1 - matrix_3) == "invalid matrix dimensions"
assert (matrix_1 - matrix_5).rows == [[2, 0], [1, 0], [0, 0]]

assert (matrix_5 * 2).rows == [[2, 4], [6, 8], [10, 12]]
assert (matrix_2 * 6).rows == [[24, 0, 12], [0, 36, 18]]

assert (matrix_4 @ matrix_3).rows == [[13, 20], [5, 8]]
assert (matrix_2 @ matrix_1).rows == [[22, 20], [39, 42]]
