...
assert (
    round(coefficients[0], 3) == 2.197
    and round(coefficients[1], 3) == -0.732
    and round(coefficients[2], 3) == -0.507
    and round(coefficients[(1, 2)], 3) == 0.620
)
...
assert coefficients == {
    (0, 1, 2): -0.024744560214742167,
    0: -4.183499420135149,
    1: 0.9324016863384199,
    2: 0.699301264753815,
    3: 0.5600435059218473,
}
