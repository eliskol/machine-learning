...
assert interaction_term_test_1.coefficients == {
    (1, 2): -0.6641667008659251,
    0: 0.9396930274551654,
    1: 1.4395493905692112,
    2: 0.7837751877539292,
}
assert interaction_term_test_1.predict([5, 5]) == -4.5478516025772615

interaction_term_test_2 = LinearRegressor()
interaction_term_test_2_data = [
    [0, 0, 0, 1],
    [1, 0, 5, 2],
    [2, 0, 1, 4],
    [4, 0, 0, 8],
...
for i in range(0, len(interaction_term_test_2_data)):
    interaction_term_test_2_data[i].insert(
        -1, interaction_term_test_2_data[i][0] * interaction_term_test_2_data[i][1]
    )
    interaction_term_test_2_data[i].insert(
        -1, interaction_term_test_2_data[i][2] * interaction_term_test_2_data[i][1]
    )
